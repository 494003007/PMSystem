 ...
 * @version 2016-10-26
 */
public class SalaryReport extends DataEntity<SalaryReport> {
	...
	private String social_secutity;
	private String orderPay;//其他扣款
	private String countOnLine;//分身个数
	private String tax;//税收
	
	@ExcelField(title="个人所得税", align=3, sort=2000)
	public String getTax() {
		return d.format(Double.parseDouble(tax==null?"0":tax));	 
	}
	...
	@ExcelField(title="代扣公积金", align=3, sort=1110)
	public String getAccumulation_fund() {
		return d.format(Double.parseDouble(accumulation_fund==null?"0":accumulation_fund));
	}
	public void setAccumulation_fund(String accumulation_fund) {
		this.accumulation_fund = accumulation_fund;
	}
	@ExcelField(title="代扣社保", align=3, sort=1120)
	public String getSocial_secutity() {
		return d.format(Double.parseDouble(social_secutity==null?"0":social_secutity));
	}
	public void setSocial_secutity(String social_secutity) {
		this.social_secutity = social_secutity;
	}
